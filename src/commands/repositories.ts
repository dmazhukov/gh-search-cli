...
`
	...
	static flags = {
		...
		created: flags.string({
			char: 'c',
			description: 'Filters repositories based on date of creation, or when they were last updated.'
		}),
		pushed: flags.string({
			char: 'p',
			description: 'Filters repositories based on date of creation, or when they were last updated.'
		...
		['current-user']: flags.boolean({
			allowNo: false,
			hidden: true,
			description: 'Limits searches to a the current git user for the --user value.'
		}),
		repo: flags.string({
			char: 'r',
		...
		language: flags.string({
			char: 'l',
			description: "Searches repositories based on the language they're written in."
		}),
